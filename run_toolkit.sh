...
java -cp ../netcdfAll-4.6.11.jar:. Target.RunToolkit /home/kerryn/Documents/Work/Toolkit2-Runs/Target-java-validation/controlfiles/Target-java-validation/Target-java-validation.txt
