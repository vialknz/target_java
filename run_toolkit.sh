...
java -cp ../netcdfAll-4.6.11.jar:slf4j-jdk14-1.7.14.jar:. Target.RunToolkit /home/kerryn/Documents/Work/Toolkit2-Runs/Target-java-validation/controlfiles/Target-java-validation/Target-java-validation.txt
